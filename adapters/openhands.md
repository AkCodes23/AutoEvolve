...
<autoevolve_mindset>
  ...
  <guardrails>
    ...
    - Error-proof by design: make invalid states unrepresentable via types, schemas, and constraints. Catch errors at compile/design time, not runtime. Fail fast with clear messages.
